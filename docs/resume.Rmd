...
Aside
================================================================================
<i class="fas fa-download"></i> Faça download desde CV em PDF: [resumido](https://rmhirota.github.io/resume/resume.pdf) ou
[completo](https://rmhirota.github.io/resume/index.pdf).
...
Este documento foi feito com o pacote de R [**pagedown**](https://github.com/rstudio/pagedown) e template por [Beatriz Milz](https://github.com/beatrizmilz/resume).

Este currículo **não** é completo. A versão completa pode ser encontrada [aqui](https://rmhirota.github.io/resume/index.pdf). 

Atualizado em `r Sys.Date()`. Versão mais recente [disponível aqui](https://rmhirota.github.io/resume/index.pdf). 
...
::: aside
<i class="fas fa-download"></i> [Baixe a versão completa do CV](https://rmhirota.github.io/resume/index.pdf)
:::